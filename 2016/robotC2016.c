#pragma config(Motor,  port2,           rightWheel,    tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port3,           leftWheel,     tmotorVex393, openLoop)
#pragma config(Motor,  port4,           rotateClaw,    tmotorVex393, openLoop)
